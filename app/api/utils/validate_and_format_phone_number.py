...
def validateAndFormatPhoneNumber(phoneNumber: str):
    try:
        ...
        formattedPhoneNumberInternational = phonenumbers.format_number(
            parsedPhoneNumber, phonenumbers.PhoneNumberFormat.INTERNATIONAL)

        return {
            "success": True,
            "formattedPhoneNumber": formattedPhoneNumber,
            "formattedPhoneNumberInternational": formattedPhoneNumberInternational
        }
    except:
        return {
            "success": False,
